...
<section class="section-slide">
    ...
    <div class="item-slick1" style="background-image: url(/resources/images/blazer.jpg);">
        <div class="container h-full">
            <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                ...
                <div class="layer-slick1 animated visible-false" data-appear="slideInUp" data-delay="1600">
                    <a href="/product/showOne/2" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
                        구 매 하 기
                    </a>
                </div>
            </div>
            ...
            <div class="item-slick1" style="background-image: url(/resources/images/wallpaper.webp);">
<%--            <div class="item-slick1" style="background-image: url(/resources/images/main2.jpg);">--%>
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									NIKE ALL TIME LEGEND
								</span>
                        </div>
...
<%--                                NEW SEASON--%>
                        ...
                        <div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
                            <a href="/product/showOne/1" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
<%--                                Shop Now--%>
                                구 매 하 기
                            </a>
                        </div>
...
<%--            <div class="item-slick1" style="background-image: url(/resources/images/slide-03.jpg);">--%>
                <div class="item-slick1" style="background-image: url(/resources/images/main1.jpg);">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
...
<%--                                <img src="/resources/images/AF1-2.png" alt="IMG-PRODUCT">--%>
                                <img src="data:image/png;base64,${item.img1} "alt="IMG-PRODUCT" />

                                <a href="/product/showOne/${item.id}"
...
<!--===============================================================================================-->
<script src="/resources/vendor/perfect-sc rollbar/perfect-scrollbar.min.js"></script>
<script>
